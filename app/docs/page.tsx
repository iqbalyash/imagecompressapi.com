...
export default function DocsPage() {
                ...
                <div className="overflow-x-auto mb-6">
                  <table className="w-full border border-gray-200 rounded-lg">
                    <thead className="bg-light-gray">
                      <tr>
                        <th className="px-4 py-3 text-left text-sm font-semibold text-dark-slate border-b border-gray-200">
                          Parameter
                        </th>
                        <th className="px-4 py-3 text-left text-sm font-semibold text-dark-slate border-b border-gray-200">
                          Type
  ...
  -F "width=1200"`}</code>
                ...
                <div className="bg-slate-900 rounded-lg p-6 overflow-x-auto mb-4">
                  <pre className="text-gray-100 text-sm">
                    <code>{`{
  "success": true,
  "data": {
  ...
  "error": {
    ...
    "message": "Invalid or missing API key"
              ...
              <section>
                ...
                <p className="text-base text-slate-700 leading-relaxed mb-4">
                  Official SDKs are available for popular programming languages to simplify integration with our <strong className="text-dark-slate">image compression API</strong>:
                </p>
              ...
              <section className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="space-y-6 text-base text-slate-700 leading-relaxed">
                  <p>
                    Our <strong className="text-dark-slate">image compression API</strong> provides a simple, powerful way to optimize images programmatically. Whether you're building a content management system, e-commerce platform, or mobile application, our API handles image compression seamlessly. The <strong className="text-dark-slate">bulk image compression API</strong> allows you to process hundreds of images in a single request, making it ideal for batch operations and automated workflows.
                  </p>
                  <p>
                    The <strong className="text-dark-slate">image resize API</strong> gives you precise control over output sizes. You can specify exact dimensions, maintain aspect ratios, or crop images to specific requirements. When combined with compression, our <strong className="text-dark-slate">image compression and resize API</strong> becomes a complete solution for all your image optimization needs.
                  </p>
                  <p>
